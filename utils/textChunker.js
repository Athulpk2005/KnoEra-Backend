...
export const chunkText = (text, chunkSize = 500, overlap = 50) => {
    ...
    //Clean text while preserving new lines
    ...
    for (const paragraph of paragraphs) {
        ...
        //if adding this paragraph exceeds chunk sise, save current chunk and start new chunk
...
/**
 * Find relevent chunks basec on keyword matching
...
export const findRelevantChunks = (chunks, query, maxChunks = 3) => {
    ...
    const stopWords = new Set([
        ...
        'but', 'with', 'to', 'for', 'of', 'as', 'by', 'this', 'that', 'it'
    ]);
